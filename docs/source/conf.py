...
# -*- coding: utf-8 -*-
#
# VideoPlayerWidget documentation build configuration file
#
...
project = 'VideoPlayerWidget'
copyright = '2021, Dharanish Kedarisetti'
...
_version_py = os.path.join(repo, 'VideoPlayerWidget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'VideoPlayerWidgetdoc'
...
latex_documents = [
    (master_doc, 'VideoPlayerWidget.tex', 'VideoPlayerWidget Documentation',
     'Dharanish Kedarisetti', 'manual'),
]
...
man_pages = [
    (master_doc,
    'VideoPlayerWidget',
    'VideoPlayerWidget Documentation',
     [author], 1)
]
